<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeBehind="DashboardAppointments.aspx.cs" Inherits="licenta_test.DashboardAppointments" %>
...
<head runat="server">
    ...
    <link href="dashboard/css/buttons.css" rel="stylesheet"/>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Appointments</h6>
                                ...
                                <div style="text-align: center; margin-top:30px;">
                                  <hr class="main-hr" />
                                  <asp:Button ID="cancelButton" CssClass="icon-btn add-btn" runat="server" Text="Cancel" OnClick="cancelButton_Click" />
                                  <asp:Button ID="removeButton" CssClass="icon-btn add-btn" runat="server" Text="Remove" OnClick="removeButton_Click" />
                                  <asp:Button ID="modifyButton" CssClass="icon-btn add-btn" runat="server" Text="Modify" OnClick="modifyButton_Click" />
            ...
            <div class="input-field">
              ...
              <asp:TextBox id="Doctor" runat="server" type="text" placeholder="Doctor"/>
            </div>
                                         <div class="input-field">
             
              <asp:TextBox id="Phone" runat="server" type="text" placeholder="Phone"/>
            </div>
                                      <div class="input-field">
             
              <asp:TextBox id="Date" runat="server" type="text" placeholder="Date"/>
            </div>
                                      <div class="input-field">
             
              <asp:TextBox id="Time" runat="server" type="text" placeholder="Time"/>
            </div>
            ...
            <asp:Button href="Index.aspx" id="b_login" Text="Save" runat="server" type="submit" value="Save" class="btn solid" OnClick="b_save_Click" />
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <asp:Table ID="appointmentsTable" runat="server" CssClass="table table-bordered">
                        <asp:TableHeaderRow>
                            <asp:TableHeaderCell ID="NameColumn" BackColor="" >Name</asp:TableHeaderCell>
                            <asp:TableHeaderCell ID="EmailColumn" BackColor="">Email</asp:TableHeaderCell>
                            <asp:TableHeaderCell ID="DoctorColumn" BackColor="">Doctor</asp:TableHeaderCell>
                            <asp:TableHeaderCell ID="PhoneColumn" BackColor="">Phone</asp:TableHeaderCell>
                            <asp:TableHeaderCell ID="DateColumn" BackColor="">Date</asp:TableHeaderCell>
                            <asp:TableHeaderCell ID="TimeColumn" BackColor="">Time</asp:TableHeaderCell>
                            <asp:TableHeaderCell ID="CheckBox">
                            Select
                        </asp:TableHeaderCell>
                        </asp:TableHeaderRow>  
                        </asp:Table>
