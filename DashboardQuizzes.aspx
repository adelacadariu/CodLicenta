<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeBehind="DashboardQuizzes.aspx.cs" Inherits="licenta_test.DashboardQuizzes" %>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <asp:Table ID="resultsTable" runat="server" CssClass="table table-bordered">
                                <asp:TableHeaderRow>
                                    <asp:TableHeaderCell>Id</asp:TableHeaderCell>
                                    <asp:TableHeaderCell>Points</asp:TableHeaderCell>
