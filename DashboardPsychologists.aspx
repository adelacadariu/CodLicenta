<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeBehind="DashboardPsychologists.aspx.cs" Inherits="licenta_test.DashboardPsychologists" %>
...
<head runat="server">
   <meta charset="utf-8">
    ...
    <title>Dashboard Psychologists</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="input-field">
              ...
              <asp:TextBox id="ImgURL" runat="server" type="text" placeholder="ImgUrl"/>
            </div>
            ...
            <asp:Button href="Index.aspx" id="b_login" Text="Save" runat="server" type="submit" value="Save" class="btn solid" OnClick="b_save_Click" />
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <asp:Table ID="psychologistsTable" runat="server" CssClass="table table-bordered">
                                <asp:TableHeaderRow>
                                    <asp:TableHeaderCell>Name</asp:TableHeaderCell>
                                    <asp:TableHeaderCell>Email</asp:TableHeaderCell>
                                    <asp:TableHeaderCell>ImgUrl</asp:TableHeaderCell>
                                </asp:TableHeaderRow>
                            </asp:Table>
                            </div>
                        </div>
