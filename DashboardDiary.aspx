<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardDiary.aspx.cs" Inherits="licenta_test.DashboardDiary" %>
...
<head runat="server">
    ...
    <title>Dashboard Journal Entries</title>
    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="DasboardDiary.aspx?username=<%= Request.QueryString["username"] %>">
                    <i class="fas fa-fw fa-table"></i>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <asp:Table ID="messagesTable" runat="server" CssClass="table table-bordered">
                                <asp:TableHeaderRow>
