<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="DashboardMessages.aspx.cs" Inherits="licenta_test.DashboardMessages" %>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <!-- Sidebar - Brand -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="DasboardMessages.aspx?username=<%= Request.QueryString["username"] %>">
                    <i class="fas fa-fw fa-table"></i>
