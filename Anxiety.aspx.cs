...
namespace licenta_test
{
    public partial class Anxiety : System.Web.UI.Page
    {
        ...
        {
            string xmlFilePath = @"C:\Users\User\Desktop\website-licenta\Q_Anxiety.xml";
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["username"]))
            {
                ...
                Response.Redirect("EndQuiz.aspx?username=" + username + "&points=" + points + "&testType=Anxiety");
            }
            else
            {
                Response.Redirect("EndQuiz.aspx?username=" + null + "&points=" + points + "&testType=Anxiety");
            }
