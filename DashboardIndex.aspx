<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardIndex.aspx.cs" Inherits="licenta_test.DasboardIndex" %>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <asp:Literal  ID="pastAppLiteral" runat="server"  Text="" />
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Future Appointments</div>
                                            <asp:Literal  ID="futureAppLiteral" runat="server"  Text="" />
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Quizzes
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <asp:Literal  ID="quizzesLiteral" runat="server"  Text="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Messages</div>
                                            <asp:Literal  ID="messagesLiteral" runat="server"  Text="" />
                                        </div>
                                        <div class="col-auto">
