...
namespace licenta_test
{
    public partial class Depression : System.Web.UI.Page
    {
        ...
        {
            string xmlFilePath = @"C:\Users\User\Desktop\website-licenta\Q_Depression.xml";
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["username"]))
            {
                ...
                Response.Redirect("EndQuiz.aspx?username=" + username + "&points=" + points + "&testType=Depression");
            }
            else
            {
                Response.Redirect("EndQuiz.aspx?username=" + null + "&points=" + points + "&testType=Depression");
            }
